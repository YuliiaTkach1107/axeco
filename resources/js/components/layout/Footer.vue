         ...
         <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8">
            ...
            <div class="flex flex-col gap-6 max-w-[240px]">
               ...
               <div class="flex flex-col gap-5">
                  <div v-for="(item, index) in contactInfo"  :key="index" class="flex items-start gap-5" >
                     <div  aria-hidden='true' class="w-9 h-9 rounded-[10px] shrink-0 flex items-center justify-center" :style="{ backgroundColor: item.bgColor }" v-html="item.icon"></div>
                     <!-- TEXT / LINK -->
                     <component
                        :is="item.link ? 'a' : 'p'"
                        :href="item.link"
