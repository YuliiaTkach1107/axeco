...
<MainLayout>
   <div id="services" role="main">
      <a href="#main-content"
         class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-white text-[#0D4677] px-4 py-2 rounded z-50">
      Aller au contenu principal
         ...
         <section id="main-content" class="hero relative min-h-[700px] h-screen w-full flex items-center overflow-hidden" style="background: linear-gradient(180deg, rgba(232,243,255,0.8) 0%, rgba(255,255,255,0.5) 100%)">
            ...
            <div class="px-6 flex md:flex-col justify-center lg:flex-row relative z-20 w-full max-w-7xl mx-auto pt-25 lg:pt-40 h-[100%]">
               ...
               <div class="relative hidden lg:flex w-[45vw] max-w-[600px] items-center justify-center">
                  <!-- Главная картинка -->
                  <img
                     src="/images/services/hero-office.webp"
                     class="relative z-0
                     w-[75%]
                     rotate-6
                  ...
                  <!-- Верхняя левая -->
                  <img
                     src="/images/services/hero-analysis.webp"
                     class="absolute
                     top-[10%] left-[5%]
                     w-[40%]
                     -rotate-8
                  ...
                  <!-- Нижняя правая -->
                  <img
                     src="/images/services/hero-building.webp"
                     class="absolute
                     bottom-[5%] right-[5%]
                     w-[45%]
                     h-[30%]
         ...
         <section class="services py-8 lg:py-20" aria-labelledby="services-title" style="background-image: linear-gradient(to bottom, #FFFFFF 0%, #F0F6FC 50%, #FFFFFF 100%);">
            <h2 id="services-title" class="sr-only">
                  ...
                  <div class="flex flex-col lg:flex-row gap-10 lg:gap-20">
                     ...
                     <div class="w-full lg:w-1/2 flex flex-col justify-start">
                        ...
                        <button
                           ...
                           class="group cursor-pointer text-[#1654d8] text-[18px] font-normal flex items-center gap-2 mb-2 focus-visible:ring-2 focus-visible:ring-[#F2522E]focus-visible:ring-offset-2"
                           >
