   ...
   <!-- Hero Section -->
         ...
         <div class="relative z-20 w-full max-w-7xl mx-auto px-6 pt-25 md:pt-32 lg:pt-40">
            <div class="max-w-[650px]">
               ...
               <h1 class="w-[70%] md:w-[85%] lg:w-[100%] text-[35px] md:text-[50px] lg:text-[60px] leading-tight mt-6 font-semibold text-[#0D4677]">
                  Plus qu’un syndic,<br />votre partenaire au quotidien
               </h1>
               ...
               <div class="flex flex-col lg:flex-row gap-4 w-54 w-[240px] md:w-[280px] lg:w-auto">
                  <Link :href="route('Contact', { subject: 'commande' }) + '#' + backSection" class="inline-flex items-center gap-3 w-fit cursor-pointer px-4 lg:px-10 py-4 rounded-[33px] text-white font-semibold text-[16px] bg-[color:var(--accent)] shadow-[4px_4px_10px_rgba(0,0,0,0.25)] hover:bg-[#d94827] transition-all active:scale-[0.97] focus:outline-none touch-manipulation">
                     Demander une plaque <ArrowRight />
                  </Link>
                  <Link :href="route('Contact') + '#' + backSection" class="inline-flex items-center gap-3 w-fit lg:w-auto cursor-pointer px-6 lg:px-10 py-4 rounded-[33px] text-[color:var(--text-dark-blue)] border-2 border-[color:var(--text-dark-blue)] font-semibold text-[16px] shadow-[4px_4px_10px_rgba(0,0,0,0.25)] hover:text-[color:var(--accent)] border-[color:var(--accent)] transition-all active:scale-[0.97] focus:outline-none touch-manipulation">
                     Contactez-nous!
                  </Link>
               </div>
            </div>
      ...
      <section class="relative flex flex-col items-center justify-center gap-3 py-8 px-6 lg:py-12 lg:px-12 text-center bg-white max-h-screen overflow-hidden">
         ...
         <div aria-hidden="true" class="relative mb-2 group flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-12 h-12 lg:w-14 lg:h-14 border-2 border-[#205a8c] rounded-lg transition-transform duration-500 group-hover:scale-110">
         ...
         <div class="flex flex-col items-center flex-1 justify-center overflow-auto max-h-[80vh]">
            ...
            <p class="text-[16px] lg:text-[18px] text-[#436086] max-w-[100%] leading-relaxed mt-1">
      ...
      <section class="bg-gradient-to-r from-[#F0F6FC] to-[#ffffff] py-16 lg:py-20">
         <div class="flex flex-col items-center justify-center text-center">
            ...
            <div class="flex flex-col items-center text-center mb-5 lg:mb-8">
               ...
               <h3 class="text-[28px] lg:text-[40px] mb-[13px]">À propos</h3>
            ...
            <div class="flex flex-col lg:flex-row gap-10 lg:gap-20 items-center justify-center mb-16 lg:mb-[100px] w-[90%]">
               ...
               <div class="w-full lg:w-[40%] bg-gradient-to-b from-[rgb(32,90,140)] to-[rgb(32,90,140,0.8)] rounded-[20px] p-8 lg:p-10 flex flex-col gap-6 lg:gap-8 text-left">
                  ...
                  <p class="text-[14px] lg:text-[16px] text-[color:rgb(255,255,255)] font-normal">
                     Fort de 30 ans d'expertise, <strong class="text-white">Axeco</strong> accompagne les copropriétés bruxelloises avec une vision engagée propre à ses valeurs : <strong class="text-white">allier éthique et transparence</strong>. Notre équipe pluridisciplinaire met son savoir-faire technique, juridique et financier au service d'une
                     <strong class="text-white">gestion sur mesure</strong> axée sur la <strong class="text-white">collaboration</strong> pour
                     <strong class="text-white">valoriser durablement</strong> votre patrimoine en
                     <strong class="text-white">transformant chaque défis en opportunité.</strong>
                  </p>
                  <Link :href="route('A_propos')" class="inline-flex items-center gap-3 px-8 lg:px-10 py-3 lg:py-4 rounded-[33px] w-fit text-white font-semibold text-[15px] lg:text-[16px] bg-[color:var(--accent)] shadow-[4px_4px_10px_rgba(0,0,0,0.25)] hover:bg-[#d94827] transition-all active:scale-[0.97] focus:outline-none touch-manipulation">
                     En savoir plus <ArrowRight />
                  </Link>
               </div>
            </div>
            <!-- Bottom CTA -->
            <div class="flex flex-col items-center justify-center text-center border border-dashed border-[#205A8C] bg-[#fbfbfb] rounded-[20px] w-[90%] lg:w-[70%] m-auto py-8 px-6">
               <p class="font-semibold text-[20px] lg:text-[26px] pb-6">
                  Derrière nos services se trouve une équipe de spécialistes
               </p>
               <Link :href='route("Notre_equipe")' class="inline-flex items-center gap-3 px-10 py-4 rounded-[33px] text-white font-semibold text-[16px] bg-[color:var(--accent)] shadow-[4px_4px_10px_rgba(0,0,0,0.25)] hover:bg-[#d94827] transition-all active:scale-[0.97] focus:outline-none touch-manipulation">
                  Découvrir l’équipe<ArrowRight />
               </Link>
            </div>
         </div>
      </section>
      ...
      <section class="py-16 lg:py-20">
                  ...
                  <a
                     ...
                     style="background-image: linear-gradient(-42deg,#ffffff 43%,rgba(224, 239, 255, 0.5) 100%);">
                        <div
                           ...
                           style="background-image:linear-gradient(180deg,rgba(32, 90, 140, 0.2),rgba(255, 255, 255, 0.2)),linear-gradient(90deg, #205a8c, #205a8c);"
                           v-html="service.icon"/>
                           <h3 class="text-[20px] font-semibold text-[#0d4677] mb-4">
                              {{ service.title }}
                           </h3>
                           <p class="text-[16px] text-[#436086] leading-relaxed">
                              {{ service.description }}
                           </p>
                  </a>
               </SwiperSlide>
            ...
            <div class="grid gap-10 grid-cols-1 lg:grid-cols-3 lg:max-w-[95%]">
               <a v-for="(service, index) in services" :key="index" :href="service.link" class="cursor-pointer group block">
                  <div class="relative h-[100%] rounded-[24px] p-10 border-2 border-[#c6e0fa] transition-all duration-300 group-hover:-translate-y-2 group-hover:shadow-[0px_15px_35px_rgba(16,43,64,0.25)]"
                     ...
                     <!-- Icon -->
                     <div
                        class="w-[60px] h-[60px] rounded-[10px] mb-8 flex items-center justify-center"
                        style="background-image:linear-gradient(180deg,rgba(32, 90, 140, 0.2),rgba(255, 255, 255, 0.2)),linear-gradient(90deg, #205a8c, #205a8c);"
                        v-html="service.icon"/>
                        <!-- Title -->
                        ...
                        <!-- Description -->
                        <p class="text-[18px] text-[#436086] leading-relaxed">
                           {{ service.description }}
                        </p>
                     </div>
               </a>
         ...
         <div class="flex justify-center mt-8">
            <Link :href="route('Services')" class="inline-flex items-center gap-3 px-10 py-4 rounded-[33px] text-white font-semibold text-[16px] bg-[#0D4677] shadow-[4px_4px_10px_rgba(0,0,0,0.25)] hover:bg-[color:var(--accent)] transition-all active:scale-[0.97] focus:outline-none touch-manipulation">
               Découvrir tous nos services<ArrowRight />
            </Link>
         </div>
      </section>
      <!-- Actualités -->
      <section class="py-16 lg:py-20 bg-[color:var(--bg-light-2)]">
         ...
         <div class="lg:hidden block relative max-w-[90%] md:max-w-[75%] mx-auto">
               ...
               <div v-for="(item, index) in mobileNews" :key="item.id" class="flex-shrink-0 w-full max-w-[85%] md:max-w-[70%] snap-start snap-always">
                  <a :href="`/actualites/article/${item.id}`" class="block rounded-lg overflow-hidden bg-white shadow-xs">
                     ...
                     <div class="py-6 px-4 flex flex-col justify-between h-[110px] md:h-[110px]">
                        <h4 class="text-[18px] font-semibold text-[#0d4677] mb-1 clamp-1">{{ item.title }}</h4>
            ...
            <div class="w-[90%] h-1 bg-[#c6e0fa] rounded overflow-hidden mx-auto mt-8 mb-10">
               <div class="h-full bg-[#f2522e] transition-all duration-300" :style="{ width: progress + '%'}"></div>
            </div>
            <!-- Bottom Button -->
            <div class="flex justify-center">
               <Link :href="route('Actualites')" class="inline-flex items-center gap-3 px-10 py-4 rounded-[33px] text-white font-semibold text-[16px] bg-[#0D4677] shadow-[4px_4px_10px_rgba(0,0,0,0.25)] hover:bg-[color:var(--accent)] transition-all active:scale-[0.97] focus:outline-none touch-manipulation">
                  Découvrir toutes les actualités <ArrowRight />
               </Link>
            </div>
         </div>
         <!-- Desktop -->
         <div class="hidden lg:block relative max-w-[100%] mx-auto">
            <div class="absolute top-2 right-4 flex gap-4 z-20">
               <button aria-label="Actualité précédente" @click="prev" :disabled="isBeginning" class="w-10 h-10 rounded-full bg-white shadow flex items-center justify-center cursor-pointer hover:bg-gray-100 transition disabled:opacity-50">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                  </svg>
               </button>
               <button aria-label="Actualité suivante" @click="next" :disabled="isEnd" class="w-10 h-10 rounded-full bg-white shadow flex items-center justify-center cursor-pointer hover:bg-gray-100 transition disabled:opacity-50" >
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
      ...
      <section class="bg-[color:var(--bg-light-2)] pb-20">
         <div class="bg-gradient-to-b from-[rgb(32,90,140)] to-[rgb(32,90,140,0.8)] rounded-[20px] max-w-[90%] mx-auto py-8 px-8 text-center text-white flex flex-col items-center gap-8 lg:gap-6">
            ...
            <!-- Bottom Button -->
            <div class="flex justify-center">
               <Link :href="route('Contact', { subject: 'demande' }) + '#' + backSection" class="inline-flex items-center gap-3 text-start w-full px-10 py-4 rounded-[33px] text-white font-semibold text-[16px] bg-[color:var(--accent)] shadow-[4px_4px_10px_rgba(0,0,0,0.25)] hover:bg-[#d94827] transition-all active:scale-[0.97] focus:outline-none touch-manipulation" >
      ...
      <section class="py-16 lg:py-20">
         <!-- Header -->
         <div class="flex flex-col items-center text-center mb-10 lg:mb-13">
            <h2 class="text-[12px] mb-[13px] text-[color:var(--text-orange)]">QUESTIONS FREQUÉNTES</h2>
            <h3 class="text-[28px] lg:text-[40px] mb-[13px] text-[color:var(--text-blue-dark)]" >FAQ’s</h3>
            <!-- Divider -->
         ...
         <div v-for="(item,index) in faq" :key="item.id" class="w-[95%] max-w-[95%] md:w-[80%] max-w-[80%] lg:max-w-[60%] mx-auto mb-6 border-2 border-[#C6E0FA] rounded-[20px] p-6 bg-gradient-to-r from-white to-[#E0EFFF]/50">
            <button @click="toggle(index)" :aria-expanded="openIndex === index ? 'true' : 'false'" :aria-controls="`faq-${index}`" class="w-full flex justify-between items-center text-left cursor-pointer py-3 active:scale-[0.98] transition-transform">
               ...
               <!-- Arrow -->
               <svg aria-hidden="true" class="w-5 h-5 transition-transform duration-300" :class="openIndex === index ? 'rotate-180 stroke-[color:var(--accent)]' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor">
         ...
         <div class="flex flex-col items-center justify-center text-center border border-dashed border-[#205A8C] bg-[#FBFBFB] rounded-[20px] opacity-100 w-[95%] lg:w-[70%] px-6 m-auto py-10 mt-20">
            ...
            <Link :href="route('FAQ')" class="inline-flex items-center gap-3 px-10 py-4 rounded-[33px] text-white font-semibold text-[16px] bg-[#0D4677] shadow-[4px_4px_10px_rgba(0,0,0,0.25)] hover:bg-[color:var(--accent)] transition-all active:scale-[0.97] focus:outline-none touch-manipulation">
               Accéder à notre FAQ <ArrowRight />
            </Link>
         </div>
      </section>
   </div>
